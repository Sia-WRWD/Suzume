<%-- 
    ...
    Created on : Apr 3, 2023, 1:20:00 AM
    Author     : Sia_RTX3070
--%>
    ...
    <body>
                            ...
                            <div class="card-body p-md-5">
                                ...
                                <div class="row justify-content-center">
                                        ...
                                        <form class="mx-1 mx-md-4" method="POST" action="${pageContext.request.contextPath}/Register">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text" id="department" class="form-control text-white" name="department" required 
                                                           oninput="checkInputs()"/>
                                                    <label class="form-label text-white" for="department">Your Department</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex justify-content-center align-items-center order-1 order-lg-2 tilt-this" data-tilt>
                                        ...
                                        <img src="/epda-assignment-war/authentication/admin-register.png"
        ...
        <script type="text/javascript">
            ...
            function checkInputs() {
                ...
                if (department && username && email && password && repassword && address) {
                    var validDepartment = validateDepartmentInput(department);
                    var validUsername = validateUsernameInput(username);
                    var validEmail = validateEmail(email);
                    var validPwds = validatePwd(password, repassword);

                    if (validDepartment && validUsername && validEmail && validPwds) {
