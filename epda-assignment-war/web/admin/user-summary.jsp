<%-- 
    Document   : user-summary
    Created on : Apr 9, 2023, 11:54:36 AM
    Author     : Sia_RTX3070
--%>
                                ...
                                <div class="card-body d-flex justify-content-center align-items-center w-100 h-100">
                                    <div class="container" style="text-shadow: 1px 2px 3px black;">
                                        <div class="row align-items-center">
                                            <p class="my-4 col fw-bold text-primary" style="font-size: 40px; text-decoration: underline;">User Summary</p>
                                        </div>
                                        <div class="row mb-4 border p-4">
                                            <div class="col text-center">
                                                <h1 class="text-danger">${customerCount}</h1>
                                                <h3 class="text-warning" style="text-shadow: 1px 2px 3px black;">Total Customers</h3>
                                                <i class="fas fa-user fa-fw text-success" style="font-size: 60px; filter: drop-shadow(1px 2px 3px black);"></i>
                                            </div>
                                            <div class="col text-center">
                                                <h1 class="text-success">${sellerCount}</h1>
                                                <h3 class="text-danger" style="text-shadow: 1px 2px 3px black;">Total Sellers</h3>
                                                <i class="fas fa-shop fa-fw text-warning" style="font-size: 60px; filter: drop-shadow(1px 2px 3px black);"></i>
                                            </div>
                                            <div class="col text-center">
                                                <h1 class="text-warning">${adminCount}</h1>
                                                <h3 class="text-success" style="text-shadow: 1px 2px 3px black;">Total Admins</h3>
                                                <i class="fas fa-hammer fa-fw text-danger" style="font-size: 60px; filter: drop-shadow(1px 2px 3px black);"></i>
                                            </div>
                                        </div>
...
<style>
    .bg {
        background-image: url("https://thechuunicorner.files.wordpress.com/2019/09/lt1wfa0.png");
