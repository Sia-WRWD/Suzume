<%-- 
    Document   : seller-register
    Created on : Apr 3, 2023, 1:19:54 AM
    Author     : Sia_RTX3070
--%>
    ...
    <body>
                            ...
                            <div class="card-body p-md-5">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Seller Sign Up</p>
                                        ...
                                        <form class="mx-1 mx-md-4" method="POST" action="${pageContext.request.contextPath}/Register">
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text" id="shopName" class="form-control text-white" name="shopName" required 
                                                           oninput="checkInputs()"/>
                                                    <label class="form-label text-white" for="shopName">Shop Name</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex justify-content-center align-items-center order-1 order-lg-2 tilt-this" data-tilt>
                                        ...
                                        <img src="/epda-assignment-war/authentication/seller-register.png"
        ...
        <script type="text/javascript">
            ...
            function checkInputs() {
                ...
                if (shopname && username && email && password && repassword && terms && address) {
                    var validShopName = validateUsernameInput(shopname);
                    var validUsername = validateUsernameInput(username);
                    var validEmail = validateEmail(email);
                    var validPwds = validatePwd(password, repassword);

                    if (validUsername && validEmail && validPwds && validShopName) {
